### On Thu, Jan 29, 2026 at 5:20 PM Bonnie Lucas <bonnie@lesaz.com> wrote:

Thank you Amanda for facilitating this.
...
| Item                                                                         | Status | Notes                                        |
| ---------------------------------------------------------------------------- | ------ | -------------------------------------------- |
| Get all officers over to the native app                                      | ✅     | Off web app; notify officers                 |
| Resolve conflicting clocking in/out issues quickly                           | ✅     | Rehydration + stop web/native clock mismatch |
| Resolve all AWS and local Dev server + security concerns before new projects | ✅     | GingerSec domain                             |
...
We will schedule time next week with Ashley and the coordinators to get all their concerns and needs identified.
